...
const Footer = () => {
    return (
        <div>
            <footer style={{background:'#0C152A'}} class="footer p-10 bg-neutral text-base-content text-white">
            ...
            <footer class="footer px-10 py-4 border-t bg-neutral text-base-content border-base-300 text-white ">
                <div class="items-center grid-flow-col text-white">
                    ...
                    <p className='font-bold'>Tools Zone<br />Providing reliable tech since 1992</p>
                </div>
                <div class="md:place-self-center md:justify-self-end  text-white">
