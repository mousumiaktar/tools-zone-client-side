        ...
        <div class="card bg-base-100 shadow-xl">
            ...
            <div class="card-body">
                <div className='flex flex-row'>
                    ...
                    <h1 className='text-xl text-[#FFA924]' style={{ marginLeft: '100px'}}><b>${price}</b></h1>
                </div>
                <p><small>{description}</small></p>
                <div class="card-actions justify-end">
                    <button onClick={() => navigatePurchase(_id)} class="btn btn-primary bg-[#1586B5]">Buy Now</button>
                </div>
            </div>
