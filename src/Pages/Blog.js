    ...
    return (
        <div className='mt-10 mb-15 max-w-7xl mx-auto px-12'>
            ...
            <div className='mb-5'>
                ...
                <p>
                    <b><u>Global (UI) state  Global state:</u></b> Global (UI) state  Global state is data we manage across multiple components.
                    Global state is necessary when we want to get and update data anywhere in our app, or in multiple components at least.
                </p>
                <p>
                    <b><u>Server state:</u></b> Server state Data that comes from an external server that must be integrated with our UI state.
                    Server state is a simple concept, but can be hard to manage alongside all of our local and global UI state.
                </p>
                <p>
                    <b><u>URL state:</u></b> Data that exists on our URLs, including the pathname and query parameters.
